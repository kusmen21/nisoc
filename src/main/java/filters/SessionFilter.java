...
/**
 *Определяет вошел ли человек и активна ли его сессия
 */
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //WRAPPERS для расширения функционала
        ...
        try
        {
            if (session == null || !session.getAttribute("isOn").equals("true")){
